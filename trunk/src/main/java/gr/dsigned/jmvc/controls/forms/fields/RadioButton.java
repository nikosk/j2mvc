...
public class RadioButton {
    ...
    public String render() {
        return String.format("%3$s<input type='radio' name='%1$s' id='%2$s_%4$s' value='%4$s' %5$s %6$s/>", getFieldName(), "id_" + getFieldName(), getRadioLabel(), getValue(), (isChecked()) ? "checked" : "", isDisabled() ? "disabled" : "");
    }
