...
//        return out;
//    }
     public String renderArticleTitlesWithDelete(ArrayList<Hmap> posts, int i, String category) throws Exception {
...
//    public String buildMenu(String controller, String method, ArrayList<Hmap> rawCats) throws Exception {
//        String out = "<ul>";
//        for (Hmap row : rawCats) {
