...
public class Validation extends Library {
    ...
    public static String parseString(String input, String inputName, int minLength, int maxLength, Hmap errors)
    {
        String output = "";
    ...
    public static String parseStringAllowEmpty(String input, String inputName, int minLength, int maxLength, Hmap errors)
    {
        String output = "";
    ...
    public static String parseEmail(String input, String inputName, int minLength, int maxLength, Hmap errors)
    {
