 ...
 * @author nikos
 */
public class CMSAdapter extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if (debug) {
            req.setAttribute("begin_time", System.nanoTime());
        } // keep time for debug purposes.
        req.setCharacterEncoding(Settings.get("DEFAULT_ENCODING"));
        processRequestMain(req, resp);
    }
    ...
    private void processRequestMain(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            this.processReroutedRequest(request, response);
     ...
     */
    private void processReroutedRequest(HttpServletRequest request, HttpServletResponse response) {
        String path = request.getRequestURI();
        try {
            ...
            request.setAttribute("controller_name", pathParts.get(1)+"_page");
